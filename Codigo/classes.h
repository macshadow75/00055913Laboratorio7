...
enum parameters {CONSTANT_T,CONSTANT_K,CONSTANT_L,CONSTANT_PX,CONSTANT_PY,CONSTANT_D,CONSTANT_E};
...
class mesh{
    ...
    public:
        void setParameters(float T,float K, float L, float PsiX, float PsiY, float D, float E){
            parameters[CONSTANT_T]=T;
            parameters[CONSTANT_K]=K;
            parameters[CONSTANT_L]=L;
            parameters[CONSTANT_PX]=PsiX;
            parameters[CONSTANT_PY]=PsiY;
            parameters[CONSTANT_D]=D;
            parameters[CONSTANT_E]=E;
        }
